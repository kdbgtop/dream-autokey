...
dependencies {
    ...
    // -- dream-platform --
    implementation("cc.dreamcode.platform:bukkit:1.13.5")
    implementation("cc.dreamcode.platform:bukkit-config:1.13.5")
    implementation("cc.dreamcode.platform:dream-command:1.13.5")
    implementation("cc.dreamcode.platform:persistence:1.13.5")
